...
def parse_arguments():
    ...
    parser.add_argument(
        '--model_path',
        type=str,
        default="/inference/examples/canary/canary_model/canary_in22_multilingual_tokenizer_iv_ft-averaged.nemo",
    )
...
class CanaryModel:
    ...
    def export_encoder(self):
        ...
        try:
            ...
            with autocast, torch.no_grad(), torch.inference_mode():
                ...
                torch.save(self.model.encoder.state_dict(), os.path.join(encoder_path, "encoder.pt"))
    ...
    def convert_decoder(self):
        ...
        decoder_path = f"{self.args.output_dir}/decoder"
        os.makedirs(decoder_path, exist_ok=True)
        torch.save(self.model.transf_decoder.state_dict(), os.path.join(decoder_path, "decoder.pt"))
